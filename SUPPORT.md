...
- Read [README.md](README.md) for requirements and build instructions.
- Search existing GitHub issues.
- Run `./scripts/check.sh` when reporting a development failure.
- Read [CONTRIBUTING.md](CONTRIBUTING.md) before submitting a pull request.

## Where to Ask

- Use GitHub issues for reproducible bugs and scoped feature requests.
- Use pull requests for focused fixes and improvements.
...
metrics, API keys, signing material, or unsanitized project snapshots.
