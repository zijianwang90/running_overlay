...
repository are distributed under the repository MIT license.
...
previous third-party Bank Gothic font file was removed before open-source
...
- Weather condition PNGs under
  ...
  the repository owner and distributed under the MIT license.
