...
- Replaced the 573-line development guide with a routing index and focused
  ...
  and quality.
- Updated contributor, agent, pull request, README, documentation-index, and
  Cursor-hook instructions to target the current monthly project log and the
  relevant development subsystem guide.
