...
- [Media Pool UI Spec](./panels/media-pool/media-pool-ui.md): left Pool panel design for Media Pool, Overlay Pool, Templates, activity-first import, interactions, layout, and component guidance.
