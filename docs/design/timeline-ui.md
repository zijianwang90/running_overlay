...
- Hover data appears as a compact pill, e.g. `55:24 • 9:39 AM • 10.61 km`.
- The hover pill has a small downward-pointing arrow on its bottom edge whose tip aligns with the hovered ruler position, so the pill reads as a tooltip pointing to the timeline.
